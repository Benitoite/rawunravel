        ...
        NavigationStack {
            GeometryReader { geo in
                ...
                ZStack {
                    ...
                    Group {
                        if isLandscape {
                            AboutLandscapeView(colorScheme: colorScheme, openURL: openURL)
                        } else {
                            AboutPortraitView(colorScheme: colorScheme, openURL: openURL)
                        }
                    }
        ...
        GeometryReader { geo in
            HStack(spacing: 0) {
                ...
                VStack {
                    Spacer()
                    StarWarsScrollText()
                        .frame(width: geo.size.width * 0.55, height: 330)
                        .background(Color.black)
                        .padding(.top, 24)
                    Spacer()
                }
    ...
    var body: some View {
        VStack(spacing: 10) {
            ...
            Text("RAWUnravel")
                .font(.largeTitle)
                .bold()
                .foregroundColor(.white) // Make sure it's white!
        }
    }
}
        ...
        HStack(spacing: 40) {
            VStack {
                Button {
                    ...
                    Image("github-mark-white") // <-- Always white!
                        .resizable()
                        .scaledToFit()
...
// MARK: - Star Wars-Style Scrolling Text
